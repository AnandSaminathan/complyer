...
namespace PrinterFunctions {
  ...
  void batch(CommandResponse command_response, CommandBase command_base) {
    if(command_response.getOperation() == StringConstants::LTLSPEC or command_response.getOperation() == StringConstants::SAFETYSPEC or command_response.getOperation() == StringConstants::IC3) {
